...
:::note
Unfortunately the way search engines are stored in Waterfox changed between `6.5` → `6.6` which will have resulted in your search engline list getting reset. Apologies for the inconvenience but this was a change that happened upstream and out of our control.
:::
