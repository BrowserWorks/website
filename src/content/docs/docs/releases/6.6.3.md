...
### Theming
- Resolved a long‑standing issue where Waterfox's styles could “leak” into the web page area. Customizations now apply only to the browser interface, not to website content.
