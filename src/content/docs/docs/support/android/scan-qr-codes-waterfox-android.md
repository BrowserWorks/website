...
Modified from [Scan QR codes in Firefox for Android](https://support.mozilla.org/en-US/kb/scan-qr-codes-firefox-android) by Mozilla Contributors is licensed under [CC BY-SA 3.0](https://creativecommons.org/licenses/by-sa/3.0/).
