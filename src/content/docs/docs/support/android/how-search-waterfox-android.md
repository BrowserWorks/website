...
Modified from [Searching with Firefox for Android](https://support.mozilla.org/en-US/kb/searching-firefox-android) by Mozilla Contributors is licensed under [CC BY-SA 3.0](https://creativecommons.org/licenses/by-sa/3.0/).
