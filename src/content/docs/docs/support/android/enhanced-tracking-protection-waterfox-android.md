...
6.  Tap the lock icon in the address bar to view if _Enhanced Tracking Protection_ is on for a site.
7.  Tap under _Enhanced Tracking Protection_ and then tap each category of trackers to see exactly what’s being blocked.
