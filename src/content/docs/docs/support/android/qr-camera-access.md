...
5.  Tap Camera.
6.  Tap Allow.
7.  Close out of the Settings app, reopen Waterfox and scan the QR code.

---

:::note[Copyright and Licensing]{icon="document"}
Modified from [Grant camera access to Firefox for Android](https://support.mozilla.org/en-US/kb/camera-permissions) by Mozilla Contributors is licensed under [CC BY-SA 3.0](https://creativecommons.org/licenses/by-sa/3.0/).

Article originally written by: [Joni](https://support.mozilla.org/en-US/user/heyjoni/)
:::
