...
Modified from [Make Firefox the default browser on Android](https://support.mozilla.org/en-US/kb/make-firefox-default-browser-android) by Mozilla Contributors is licensed under [CC BY-SA 3.0](https://creativecommons.org/licenses/by-sa/3.0/).
