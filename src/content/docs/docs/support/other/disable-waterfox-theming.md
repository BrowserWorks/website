...
2.  Tap `Settings` or `Preferences` depending on your platform.
    <img alt="Settings icon in address bar in android" class="inline-image" src="./disable-waterfox-theming-1.png">
3.  Select `Look & Feel` on the navigation pane on the left hand side.
    <img alt="Settings icon in address bar in android" class="inline-image" src="./disable-waterfox-theming-2.png">
...
Modified from This article is licensed under [CC BY-SA 3.0](https://creativecommons.org/licenses/by-sa/3.0/).
