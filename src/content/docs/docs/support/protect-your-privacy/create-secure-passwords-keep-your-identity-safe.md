...
[Waterfox can also generate a secure password for you.](/support/how-generate-secure-password-waterfox)

## Step 1: Choose a phrase

You can create a more secure password by starting with a simple phrase. For example, let's use a quote from Ogden Nash: _"Happiness is having a scratch for every itch."_
...
**Waterfox offers this guide as a public service. No approach to security can guarantee 100% security, and nothing in this publication is meant to provide any warranty or guarantee of the security of your passwords.**
...
Modified from [Create secure passwords to keep your identity safe](https://support.mozilla.org/en-US/kb/create-secure-passwords-keep-your-identity-safe). Original by [Mozilla Contributors](https://support.mozilla.org/en-US/kb/create-secure-passwords-keep-your-identity-safe#doc-contributors). Licensed under the [CC BY-SA 3.0](https://creativecommons.org/licenses/by-sa/3.0/).
:::
