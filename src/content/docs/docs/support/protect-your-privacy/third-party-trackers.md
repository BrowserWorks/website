...
Modified from [Third-party trackers](https://support.mozilla.org/en-US/kb/third-party-trackers). Original by [Mozilla Contributors](https://support.mozilla.org/en-US/kb/third-party-trackers#doc-contributors). Licensed under the [CC BY-SA 3.0](https://creativecommons.org/licenses/by-sa/3.0/).
:::
