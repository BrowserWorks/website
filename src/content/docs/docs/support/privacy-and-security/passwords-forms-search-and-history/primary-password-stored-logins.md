...
_**Based on information from [Master password (mozillaZine KB)](http://kb.mozillazine.org/Master_password)**_

---

:::note[Copyright and Licensing]{icon="document"}
Modified from [Use a Primary Password to protect stored logins and passwords](https://support.mozilla.org/kb/use-primary-password-protect-stored-logins). Original by [Mozilla Contributors](https://support.mozilla.org/kb/use-primary-password-protect-stored-logins#doc-contributors). Licensed under the [CC BY-SA 3.0](https://creativecommons.org/licenses/by-sa/3.0/).
:::
