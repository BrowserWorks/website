...
If you're having problems updating Waterfox, download the Waterfox installer, then close Waterfox and run the installer.

All of your data will be preserved.

## Configure how Waterfox installs updates
...
Modified from [Update Firefox to the latest release](https://support.mozilla.org/en-US/kb/update-firefox-latest-release). Original by [Mozilla Contributors](https://support.mozilla.org/en-US/kb/update-firefox-latest-release#doc-contributors). Licensed under the [CC BY-SA 3.0](https://creativecommons.org/licenses/by-sa/3.0/).
:::
