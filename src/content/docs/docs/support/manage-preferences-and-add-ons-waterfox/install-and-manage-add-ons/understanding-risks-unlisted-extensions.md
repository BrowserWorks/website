---
slug: support/understanding-risks-unlisted-extensions
title: "Understanding the risks of installing self-hosted extensions"
---

[Extensions](/support/find-and-install-add-ons-add-features-to-waterfox) enable you to add features to Waterfox for a personalized browsing experience.

Extensions that are distributed by the developers themselves, rather than by Waterfox on [addons.mozilla.org](http://addons.mozilla.org) (AMO), are referred to as “self-hosted.” While users should exercise caution when installing extensions from any source—AMO included—users should take special care determining the trustworthiness of a self-hosted extension. Although most extensions are created by developers with the honest intent of providing great new browser features, some bad actors may use extensions to compromise your personal browsing data.
...
- **Does the extension provide a privacy policy?** It’s not necessary for every extension to provide a privacy policy, but if the extension asks for powerful [permission requests](/support/permission-request-messages-waterfox-extensions), it should provide a clear policy explaining how your data is treated. Make certain you’re comfortable with the privileges and permissions you grant.
...
Modified from [Understanding the risks of installing self-hosted extensions](https://support.mozilla.org/en-US/kb/understanding-risks-unlisted-extensions). Original by [Mozilla Contributors](https://support.mozilla.org/en-US/kb/understanding-risks-unlisted-extensions#doc-contributors). Licensed under the [CC BY-SA 3.0](https://creativecommons.org/licenses/by-sa/3.0/).
:::
