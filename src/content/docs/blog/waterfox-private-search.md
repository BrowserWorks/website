---
title: Introducing Waterfox Private Search (Beta)
date: 2025-04-30
description: Announcing the open beta of Waterfox Private Search, our new meta-search engine designed with privacy at its core.
author: Alex
---

## Announcing Waterfox Private Search

Today, I'm excited to introduce [Waterfox Private Search](https://search.waterfox.net), now available in open beta. This represents an important step in our journey toward creating a more independent and privacy-respecting browsing experience.

[Waterfox Private Search](https://search.waterfox.net) is a meta-search engine that I've developed with a clear goal: to eventually serve as the default search option for Waterfox, reducing our dependency on Microsoft and other intermediaries who typically serve as gatekeepers between you and your search results.
...
Unlike traditional search engines that build profiles of your search history, [Waterfox Private Search](https://search.waterfox.net) acts as a privacy-preserving proxy between you and search results. Each query is treated as completely fresh, as if it were coming from a new device.
...
We're planning two approaches to make [Waterfox Private Search](https://search.waterfox.net) sustainable:
...
[Waterfox Private Search](https://search.waterfox.net) is available now at [search.waterfox.net](https://search.waterfox.net). You can set it as your default search engine in Waterfox by following the [Add a new search engine](https://www.waterfox.net/support/change-your-default-search-settings-waterfox/#add-a-new-search-engine) guide.
